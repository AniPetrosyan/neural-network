...
MODEL_JOB_DIR = '/dli/data/digits/20200711-095902-a363'
...
def deploy(img_path):
    ...
    mean_image = caffe.io.load_image('/dli/data/digits/20200711-095653-5860/mean.jpg')
    ...
    ##REPLACE WITH THE FUNCTION THAT RETURNS THE OUTPUT OF THE NETWORK##([##REPLACE WITH THE INPUT TO THE FUNCTION##])
